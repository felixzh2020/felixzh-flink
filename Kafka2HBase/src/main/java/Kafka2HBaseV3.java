...
public class Kafka2HBaseV3 {

    private static final Logger LOG = LoggerFactory.getLogger(Kafka2HBaseV3.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        HBaseSinkFunctionV3<HBaseData> hbaseSinkFunction = new HBaseSinkFunctionV3<>(parameterTool);
